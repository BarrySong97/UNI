String sanitizeReaderSelectionText(String text) {
  ...
  while (start < end && _isReaderSelectionBoundaryNoise(trimmed[start])) {
    start += 1;
  }
  while (end > start && _isReaderSelectionBoundaryNoise(trimmed[end - 1])) {
    end -= 1;
  }
...
bool _isReaderSelectionBoundaryNoise(String char) {
